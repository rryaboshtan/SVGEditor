...
PAGES = [
  {
    ...
    "faqs": [
      ...
      ("Want a different angle?", "Use Rotate SVG Path 45°, 90°, 180°, 270°, or Rotate SVG Path by Degrees for a smaller step."),
    ],
    ...
    "guides": [
      ...
      ("/rotate-svg-path-90-degrees", "Rotate path 90° →"),
  ...
  },
  {
    ...
    "faqs": [
      ...
      ("Can I use exact angles like 45° or 90°?", "Yes. Open the dedicated 45°, 90°, 180°, or 270° path pages for those fixed steps."),
    ...
    "note_html": '<span class="tool-note-pair">Fixed 90°? <a href="/rotate-svg-path-90-degrees">Rotate SVG Path 90°</a></span><span class="tool-note-sep" aria-hidden="true"> · </span><span class="tool-note-pair">General path rotate? <a href="/rotate-svg-path">Rotate SVG Path</a></span>',
    "guides": [
  ...
  },
  {
    ...
    "faqs": [
      ...
      ("Need 90° instead?", "Open Rotate SVG Path 90 Degrees for a quarter-turn step."),
    ],
    "note_html": '<span class="tool-note-pair">90°? <a href="/rotate-svg-path-90-degrees">Rotate SVG Path 90°</a></span><span class="tool-note-sep" aria-hidden="true"> · </span><span class="tool-note-pair">By degrees? <a href="/rotate-svg-path-by-degrees">Rotate by Degrees</a></span>',
    "guides": [
      ("/rotate-svg-path", "Rotate SVG path →"),
      ("/rotate-svg-path-90-degrees", "Rotate path 90° →"),
      ("/rotate-svg-path-180-degrees", "Rotate path 180° →"),
      ("/rotate-svg-path-by-degrees", "Rotate by degrees →"),
    ],
  },
  {
    "slug": "rotate-svg-path-90-degrees",
    "title": "Rotate SVG Path 90 Degrees Online — Free Tool | getsvgeditor.com",
    "description": "Rotate an SVG path 90 degrees online around its center. One-click quarter turns with live preview — free, no upload.",
    "h1": "Rotate SVG Path 90 Degrees",
    "crumb": "Rotate path 90°",
    "sub": "Quarter-turn a path around the viewBox center",
    "og_alt": "Rotate SVG path 90 degrees in SVGEditor",
    "app_name": "Rotate SVG Path 90 Degrees",
    "app_alts": ["Rotate SVG path 90 degrees", "SVG path rotate 90", "Turn path 90 degrees", "Quarter turn SVG path"],
    "app_desc": "Free online tool to rotate an SVG path 90 degrees around its center with live preview.",
    "app_cat": "DeveloperApplication",
    "features": ["Rotate SVG path 90°", "Center pivot", "Live preview", "No file upload"],
    "howto_name": "Rotate an SVG path 90 degrees",
    "howto_desc": "Apply a 90° center rotation to SVG path markup online.",
    "degrees": 90,
    "sample": "path",
    "btn": "Rotate 90°",
    "btn_title": "Rotate SVG path 90 degrees around center",
    "faq_aria": "Rotate SVG path 90 degrees FAQ",
    "faqs": [
      ("How do I rotate an SVG path 90 degrees?", "Paste your SVG, then click Rotate 90°. The Angle field is prefilled to 90° but editable."),
      ("Will four clicks return the original orientation?", "Yes. 90° × 4 = 360°, and the tool clears the rotate transform back to 0°."),
      ("Does this rewrite path coordinates?", "No. It wraps content in rotate(90 cx cy) so the original d attribute stays the same."),
      ("Rotating an icon instead of a path?", "Use Rotate SVG Icon 90 Degrees for icon-focused wording and a compact sample."),
    ],
    "note_html": '<span class="tool-note-pair">180°? <a href="/rotate-svg-path-180-degrees">Rotate SVG Path 180°</a></span><span class="tool-note-sep" aria-hidden="true"> · </span><span class="tool-note-pair">Icon 90°? <a href="/rotate-svg-icon-90-degrees">Rotate SVG Icon 90°</a></span>',
    "guides": [
      ("/rotate-svg-path", "Rotate SVG path →"),
      ("/rotate-svg-path-45-degrees", "Rotate path 45° →"),
      ("/rotate-svg-path-180-degrees", "Rotate path 180° →"),
      ("/rotate-svg-path-270-degrees", "Rotate path 270° →"),
    ],
  },
  {
    "slug": "rotate-svg-path-180-degrees",
    "title": "Rotate SVG Path 180 Degrees Online — Free Tool | getsvgeditor.com",
    "description": "Rotate an SVG path 180 degrees online around its center. Flip orientation with a half turn — free, no upload.",
    "h1": "Rotate SVG Path 180 Degrees",
    "crumb": "Rotate path 180°",
    "sub": "Half-turn a path around the viewBox center",
    "og_alt": "Rotate SVG path 180 degrees in SVGEditor",
    "app_name": "Rotate SVG Path 180 Degrees",
    "app_alts": ["Rotate SVG path 180 degrees", "SVG path rotate 180", "Turn path upside down", "Half turn SVG path"],
    "app_desc": "Free online tool to rotate an SVG path 180 degrees around its center with live preview.",
    "app_cat": "DeveloperApplication",
    "features": ["Rotate SVG path 180°", "Center pivot", "Live preview", "No file upload"],
    "howto_name": "Rotate an SVG path 180 degrees",
    "howto_desc": "Apply a 180° center rotation to SVG path markup online.",
    "degrees": 180,
    "sample": "path",
    "btn": "Rotate 180°",
    "btn_title": "Rotate SVG path 180 degrees around center",
    "faq_aria": "Rotate SVG path 180 degrees FAQ",
    "faqs": [
      ("How do I rotate an SVG path 180 degrees?", "Paste your SVG, then click Rotate 180°. The Angle field is prefilled to 180° but editable."),
      ("Is a 180° rotate the same as a flip?", "No. A 180° rotate turns the shape around its center. Horizontal/vertical flip mirrors across an axis — use the Flip SVG Path tools for that."),
      ("What if I click twice?", "180° × 2 = 360°, so the transform clears and you are back to the original orientation."),
      ("Need a three-quarter turn?", "Use Rotate SVG Path 270 Degrees."),
    ],
    "note_html": '<span class="tool-note-pair">270°? <a href="/rotate-svg-path-270-degrees">Rotate SVG Path 270°</a></span><span class="tool-note-sep" aria-hidden="true"> · </span><span class="tool-note-pair">Mirror instead? <a href="/flip-svg-path-horizontally">Flip SVG Path Horizontally</a></span>',
    "guides": [
      ("/rotate-svg-path-90-degrees", "Rotate path 90° →"),
      ("/rotate-svg-path-270-degrees", "Rotate path 270° →"),
      ("/rotate-svg-path", "Rotate SVG path →"),
  ...
  {
    "slug": "rotate-svg-path-270-degrees",
    "title": "Rotate SVG Path 270 Degrees Online — Free Tool | getsvgeditor.com",
    "description": "Rotate an SVG path 270 degrees online around its center. Three-quarter turns with live preview — free, no upload.",
    "h1": "Rotate SVG Path 270 Degrees",
    "crumb": "Rotate path 270°",
    "sub": "Three-quarter turn a path around the viewBox center",
    "og_alt": "Rotate SVG path 270 degrees in SVGEditor",
    "app_name": "Rotate SVG Path 270 Degrees",
    "app_alts": ["Rotate SVG path 270 degrees", "SVG path rotate 270", "Turn path 270 degrees", "Three quarter turn SVG path"],
    "app_desc": "Free online tool to rotate an SVG path 270 degrees around its center with live preview.",
    "app_cat": "DeveloperApplication",
    "features": ["Rotate SVG path 270°", "Center pivot", "Live preview", "No file upload"],
    "howto_name": "Rotate an SVG path 270 degrees",
    "howto_desc": "Apply a 270° center rotation to SVG path markup online.",
    "degrees": 270,
    "sample": "path",
    "btn": "Rotate 270°",
    "btn_title": "Rotate SVG path 270 degrees around center",
    "faq_aria": "Rotate SVG path 270 degrees FAQ",
    "faqs": [
      ("How do I rotate an SVG path 270 degrees?", "Paste your SVG, then click Rotate 270°. The Angle field is prefilled to 270° but editable."),
      ("Is 270° the same as −90°?", "Visually yes for a single turn. This page applies +270°; Rotate SVG Path 90 Degrees the other way reaches a similar pose with more clicks."),
      ("Does the tool keep original path data?", "Yes. Rotation is applied with a transform group around the center."),
      ("Want smaller steps?", "Use Rotate SVG Path by Degrees for 15° increments."),
    ],
    "note_html": '<span class="tool-note-pair">90°? <a href="/rotate-svg-path-90-degrees">Rotate SVG Path 90°</a></span><span class="tool-note-sep" aria-hidden="true"> · </span><span class="tool-note-pair">By degrees? <a href="/rotate-svg-path-by-degrees">Rotate by Degrees</a></span>',
    "guides": [
      ("/rotate-svg-path-90-degrees", "Rotate path 90° →"),
  ...
  },
  {
    ...
    "note_html": '<span class="tool-note-pair">Around center? <a href="/rotate-svg-icon-around-center">Rotate Around Center</a></span><span class="tool-note-sep" aria-hidden="true"> · </span><span class="tool-note-pair">Path 90°? <a href="/rotate-svg-path-90-degrees">Rotate Path 90°</a></span>',
    "guides": [
      ("/rotate-svg-icon", "Rotate SVG icon →"),
